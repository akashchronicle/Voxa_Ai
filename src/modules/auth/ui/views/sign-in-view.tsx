                                 ...
                                 <div className="grid gap-3">
                                    ...
                                    ></FormField>
                                        ...
                                        <div className="text-center text-sm">
                                            Don&apos;t have an account?{" "}<Link href="/auth/sign-up" className="underline underline-offset-4">
                                            Sign up
                                            </Link>
                                        </div>
...
<div className="bg-gradient-to-br from-[hsl(30,100%,92%)] to-[#ffc228] flex flex-col items-center justify-center p-8 rounded-r-xl text-center">

  <img
    src="/logoVox.png"
    alt="Voxa AI Logo"
    className="h-[140px] w-[190px] object-contain mx-auto p-0 mb-0"
  />
  ...
  <p className="text-sm text-muted-foreground max-w-xs mt-1 italic animate-fadeIn">
    ...
    text-balance *:[a]:underline *:[a]:underline-offset-4">
        By clicking continue, you agree to our <a href="#">Terms of Services</a> and <a
